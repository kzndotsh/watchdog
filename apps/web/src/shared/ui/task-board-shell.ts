/** Task board column shell — shared with task-board-column + BoardSkeleton. */
export const TASK_BOARD_COLUMN_SHELL_CLASS =
  "relative flex h-full min-h-0 min-w-[14rem] flex-1 basis-0 flex-col";
